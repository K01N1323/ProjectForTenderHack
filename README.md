...
- поднимать похожие позиции после клика или добавления в корзину
...
- действия в текущей сессии: открытие карточки, клик, корзина, bounce
...
Это не просто поисковая строка по каталогу.
